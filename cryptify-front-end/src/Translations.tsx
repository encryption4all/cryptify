...
const english: Translation = {
  ...
  infoPanel_aboutContent: "With Cryptify you can safely send files in a privacy-friendly manner. Every file is encrypted specifically for the receiver. Only that person can decrypt that file. To do that the email address must be shown. For this the identification app <b><a href=\"https://yivi.app/\">Yivi</u></a> is used.",
