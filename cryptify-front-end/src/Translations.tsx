...
const english: Translation = {
  ...
  decryptPanel_irmaInstructionHeaderQr: "Scan QR-code with Yivi",
  decryptPanel_irmaInstructionHeaderMobile: "Prove your identity with Yivi",
  decryptPanel_irmaInstructionQr: "Decrypt the files by verifying your e-mail address. Please scan the QR-code below with the identification app Yivi.",
  decryptPanel_irmaInstructionMobile: "Decrypt the files by verifying your e-mail address. Please click the button below to open the Yivi-app.",
  decryptPanel_noIrma: "Don't have the Yivi-app yet?",
  ...
  encryptPanel_irmaInstructionHeaderQr: "Show who you are by scanning the QR-code with Yivi",
  ...
  infoPanel_aboutContent: "With Cryptify you can safely send files in a privacy-friendly manner. Every file is encrypted specifically for the receiver. Only that person can decrypt that file. To do that the email address must be shown. For this the identification app <b><a href=\"https://irma.app/\">Yivi</u></a> is used.",
  infoPanel_aboutIrmaInfo: "Want to know more about the Yivi-app?",
  ...
  infoPanel_helpReceivedInstallStep1: "Install the free Yivi app (available on the <a href=\"https://apps.apple.com/app/irma-authenticatie/id1294092994\">App Store</a> on IOS. <a href=\"https://play.google.com/store/apps/details?id=org.irmacard.cardemu&hl=en\">Google Play Store</a> and <a href=\"https://f-droid.org/en/packages/org.irmacard.cardemu/\">F-Droid</a> on Android)",
  infoPanel_helpReceivedInstallStep2: "Add your email address as a card into your Yivi app. You can do this <a href=\"https://sidnemailissuer.irmaconnect.nl/uitgifte/email/\">here</a>.",
  infoPanel_helpReceivedInstallIrmaOutro: "Installing and setting up Yivi only needs to be done once!",
  infoPanel_helpReceivedUseIrma: "If you have Yivi installed, you can download and decrypt the files: ",
  infoPanel_helpReceivedUseStep1: "Click the link (to your file) in the email from Cryptify. The Cryptify website opens.",
  infoPanel_helpReceivedUseStep2: "If you are using a computer, scan the QR code on the Cryptify website with your Yivi app. If you are using a mobile phone, click the button to open the Yivi app.",
  infoPanel_helpReceivedUseStep3: "The Yivi app asks you whether you wish to disclose your email address to Cryptify. This is necessary to prove that you are the intended recipient.",
...
const dutch: Translation = {
  ...
  decryptPanel_irmaInstructionHeaderQr: "Scan QR-code met Yivi",
  decryptPanel_irmaInstructionHeaderMobile: "Bewijs identiteit met Yivi",
  decryptPanel_irmaInstructionQr: "Ontsleutel het bestand door je e-mailadres te tonen. Scan daarvoor de onderstaande QR-code met de identificatie app Yivi.",
  decryptPanel_irmaInstructionMobile: "Ontsleutel het bestand door je e-mailadres te tonen. Click daarvoor op de onderstaande knop om naar de identificatie app Yivi te gaan.",
  decryptPanel_noIrma: "Nog geen Yivi-app?",
  ...
  encryptPanel_irmaInstructionHeaderQr: "Laat zien wie je bent door de QR-code te scannen met Yivi",
  ...
  infoPanel_helpReceivedInstallStep1: "Installeer de gratis Yivi-app (beschikbaar voor <a href=\"https://apps.apple.com/nl/app/irma-authenticatie/id1294092994\">App Store</a> op IOS. <a href=\"https://play.google.com/store/apps/details?id=org.irmacard.cardemu&hl=nl\">Google Play Store</a> en <a href=\"https://f-droid.org/nl/packages/org.irmacard.cardemu/\">F-Droid</a> op Android.)",
  infoPanel_helpReceivedInstallStep2: "Voeg uw e-mailadres toe aan uw Yivi-app. U kunt dit <a href=\"https://sidnemailissuer.irmaconnect.nl/uitgifte/email/\">hier</a> doen.",
  infoPanel_helpReceivedInstallIrmaOutro: "Het installeren en instellen van Yivi hoeft maar één keer te gebeuren!",
  infoPanel_helpReceivedUseIrma: "Als u Yivi heeft geïnstalleerd, kunt u de bestanden downloaden en ontsleutelen:",
  ...
  infoPanel_helpReceivedUseStep2: "Als u een computer gebruikt, scan dan de QR-code op de Cryptify-website met de Yivi-app. Als u een mobiele telefoon gebruikt, klik dan op de knop om de Yivi app te openen.",
  infoPanel_helpReceivedUseStep3: "De Yivi-app vraagt of u uw e-mailadres wilt doorgeven aan Cryptify. Dit is nodig om te bewijzen dat u de beoogde ontvanger bent.",
